...
export default defineComponent({
  ...
  setup () {
    ...
    onMounted(() => {
      ...
      // Configuración del gráfico (similar a Chart.js)
      const options = {
        title: {
        ...
        legend: {
          ...
          itemGap: 20 // Aumentar el espacio entre los elementos de la leyenda
        },
        series: [
          {
            name: 'Rental Car',
...
h3 {
  text-align: center;
  margin-bottom: 30px; /* Se aumenta el margen inferior para separar el gráfico */
  font-size: 1.5rem;
  color: #374151;
}
